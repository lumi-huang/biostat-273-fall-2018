...
pudg_group <- pudg_group %>%
  mutate(KADistance = (kills + assists)/distance, 
         KADuration = (kills + assists)/duration,
         KillstraksperKills = killStreaks/kills,
         itemDuration = (boosts + heals + weaponsAcquired)/duration,
         itemDistance = (boosts + heals + weaponsAcquired)/distance)
```
